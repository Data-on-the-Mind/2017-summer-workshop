...
- $S$-vectors are still zero-centered vector of participant specific random effects. However, we now estimate both, variance and covariance of random effects:
...
- This model allows each participant to have an idiosyncratic intercept and slope.
